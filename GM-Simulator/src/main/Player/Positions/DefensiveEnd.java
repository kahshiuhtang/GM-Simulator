...
public class DefensiveEnd extends Person {
    ...
    public int overall(){
        return (defendGround.sumOverall()/7 + defendAir.sumOverall()/4 + universal.sumOverall()/8)/3;
    }

    public int potential(){
        return (defendGround.sumPotential()/7 + defendAir.sumPotential()/4 + universal.sumPotential()/8)/3;
    }
